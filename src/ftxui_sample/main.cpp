...
// configuration step. It creates a namespace called `KillAndKill`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", KillAndKill::cmake::project_name, KillAndKill::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", KillAndKill::cmake::project_version);
      return EXIT_SUCCESS;
    }
